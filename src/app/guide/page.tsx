      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mt-8 rounded-2xl border border-[#EBE7E0] bg-white p-6">
          ...
          <ol className="mt-4 list-decimal space-y-3 pl-5 text-sm leading-6 text-[#7A7067]">
            ...
            <li>미리보기의 ‘이 화 단일 PNG 만들기’를 누른 뒤 ‘한 화 PNG 다운로드’로 받으세요. 모든 컷과 여백·말풍선·자막을 현재 순서대로 이어 붙인 900px 폭의 세로 이미지 한 장입니다. 미리보기·출력은 AI 호출 없이 현재 편집 내용을 사용하며, 프로젝트 저장은 별도예요.</li>
