...
export default function CutNavigator({ cuts, onNavigate }: {
  ...
  return <nav aria-label="편집 컷 바로가기" className="sticky top-20 z-30 flex min-w-0 items-center gap-2 rounded-xl border border-[#DDD6FE] bg-white/95 px-3 py-2 shadow-sm backdrop-blur">
